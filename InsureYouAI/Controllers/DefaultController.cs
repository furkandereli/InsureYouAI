...
{
    public class DefaultController(InsureContext context) : Controller
    {
        ...
        public async Task<IActionResult> SendMessage(Message message)
        {
            ...
            client2.Authenticate("your_email", "api_key");
            ...
            context.ClaudeAIMessages.Add(claudeAIMessage);
            context.SaveChanges();
